export default {
    ...
    SupportDialog_QR_Instruction: "Survolez, sélectionnez ou cliquez pour afficher le code QR {{0}} local.",
    ...
    PalList_Filter_Unprioritized: "Sans priorité",
    ...
    AddPal_Default_Description: "Crée un Pal sûr dans le prochain emplacement libre de la boîte du joueur sélectionné.",
    ...
    AddPal_Target_Player: "Joueur cible",
    ...
    SkillTemplate_Equipped: "Équipée",
